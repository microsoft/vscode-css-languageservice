	...
	"css": {
		"atdirectives": [
			...
			},
			{
				...
				browsers: "E12,FF3.5,S3.1,C4,IE4,O10"
			},
			{
		...
		"pseudoclasses": [
			...
			},
			{
				...
				browsers: "E,FF1,S3.1,C1,IE9,O9.5"
			},
			{
				name: ":enabled",
			...
			},
			{
				...
				browsers: "E,FF3,S3.1,C4,IE7,O9.5"
			},
			{
				name: ":first-of-type",
			...
			},
			{
				...
				browsers: "E,FF1,S3.2,C1,IE9,O9.5"
			},
			{
				name: ":last-of-type",
			...
			},
			{
				...
				browsers: "E,FF1.5,S3.1,C2,IE9,O9.5"
			},
			{
				name: ":only-of-type",
			...
			},
			{
				...
				browsers: "E,FF4,S5,C10,IE10,O10"
			},
			{
				name: ":out-of-range",
				desc: "Used in conjunction with the min and max attributes, whether on a range input, a number field, or any other types that accept those attributes.",
			...
			},
			{
				...
				browsers: "E,FF1,S1.3,C1,IE9,O9.5"
			},
			{
				name: ":valid",
				desc: "An element is :valid or :invalid when it is, respectively, valid or invalid with respect to data validity semantics defined by a different specification.",
		...
		"pseudoelements": [
			...
			},
			{
				name: "::selection",
				desc: "Represents the portion of a document that has been highlighted by the user.",
				browsers: "E,FF62,S1.1,C1,IE9,O9.5"
			},
			{
				name: "::shadow",
		...
		"properties": [
			...
			},
			{
				...
				browsers: "E12,FF16,S,C43,IE10,O30",
			...
			},
			{
				...
				browsers: "E12,FF16,S4,C43,IE10,O30",
				restriction: "time",
				"syntax": "<time>#"
			},
			{
			...
			},
			{
				...
				browsers: "E12,FF16,S,C12,IE10,O15",
				restriction: "enum",
				values: [
					{
						name: "hidden",
			...
			},
			{
				...
				browsers: "E12,FF4,S3,C1,IE9,O9.5",
				restriction: "length, percentage",
				values: [
					{
						name: "auto",
			...
			},
			{
				...
				browsers: "E12,FF15,S6,C16,IE11,O10.5",
			...
			},
			{
				...
				browsers: "E12,FF52,S3,C50,IE10,O11.1",
			...
			},
			{
				...
				browsers: "E12,FF50,S3,C50,IE10,O11.1",
				restriction: "length, line-width",
				"syntax": "<'border-width'>"
			},
			{
			...
			},
			{
				...
				browsers: "E12,FF1,S3.1,C2,IE8,O9.2",
				restriction: "identifier, integer",
				values: [
					{
						name: "none",
			...
			},
			{
				...
				browsers: "E12,FF20,S6.1,C29,IE11,O12.1",
				restriction: "number",
				"syntax": "<number>"
			},
			{
				...
				browsers: "E12,FF20,S8,C29,IE10,O12.1",
				restriction: "number",
				"syntax": "<number>"
			},
			{
			...
			},
			{
				...
				browsers: "E12,FF9,S11,C48,IE9,O35",
				restriction: "enum",
				values: [
					{
						name: "condensed"
			...
			},
			{
				...
				browsers: "E12,FF1,S1.3,C2,IE3,O3.5",
				restriction: "enum",
				values: [
					{
						name: "100"
			...
			},
			{
				...
				browsers: "E12,FF1,S1.2,C1,IE9,O9",
				restriction: "number(0-1)",
				"syntax": "<number>"
			},
			{
			...
			},
			{
				...
				browsers: "E12,FF1.5,S3,C1,IE5,O9.5",
				restriction: "enum",
				values: [
					{
						name: "auto",
			...
			},
			{
				name: "perspective",
				desc: "Applies the same transform as the perspective(<number>) transform function, except that it applies only to the positioned or transformed children of the element, not to the transform on the element itself.",
				browsers: "E12,FF16,S,C45,IE10,O15",
				restriction: "length, enum",
				values: [
					{
						name: "none",
			...
			},
			{
				...
				browsers: "E12,FF1.5,S3,C1,IE11,O9",
				restriction: "enum",
				values: [
					{
						name: "all",
			...
			},
			{
				name: "transform",
				desc: "A two-dimensional transformation is applied to an element through the 'transform' property. This property contains a list of transform functions similar to those allowed by SVG.",
				browsers: "E12,FF16,S9,C36,IE10,O12.1",
				restriction: "enum",
				values: [
					{
						name: "matrix()"
			...
			},
			{
				...
				desc: "Establishes the origin of transformation for an element.",
				browsers: "E12,FF16,S3.1,C,IE10,O12.1",
				restriction: "position, length, percentage",
			...
			},
			{
				name: "transition",
				desc: "Shorthand property combines four of the transition properties into a single property.",
				browsers: "E12,FF16,S6.1,C26,IE10,O12.1",
				restriction: "time, property, timing-function, enum",
				values: [
					{
						name: "all",
			...
			},
			{
				...
				desc: "Defines when the transition will start. It allows a transition to begin execution some period of time from when it is applied.",
				browsers: "E12,FF16,S,C26,IE10,O12.1",
				restriction: "time",
				"syntax": "<time>#"
			},
			{
			...
			},
			{
				name: "user-select",
				desc: "Controls the appearance of selection.",
				browsers: "E12,FF,S3.1,C54,IE10,O15",
				restriction: "enum",
				values: [
					{
						name: "all",
			...
			},
			{
				...
				browsers: "E12,FF1,S1,C,IE4,O3.5",
				restriction: "length, percentage",
				values: [
					{
						name: "auto",
			...
			},
			{
				name: "word-break",
				desc: "Specifies line break opportunities for non-CJK scripts.",
				browsers: "E12,FF15,S,C1,IE5.5,O15",
				restriction: "enum",
				values: [
					{
						name: "break-all"
			...
			},
			{
				...
				browsers: "E12,FF41,S5.1,C,IE9,O15",
				restriction: "enum",
				values: [
					{
						name: "horizontal-tb"
			...
			},
			{
				...
				browsers: "E15,FF48,S,C48,IE11,O"
			},
			{
