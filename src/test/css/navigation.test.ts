...
import {
	assertColorPresentations, assertColorSymbols, assertDocumentSymbols, assertHighlights, assertLinks,
	assertScopeBuilding, assertScopesAndSymbols, assertSymbolInfos, assertSymbolsInScope, getTestResource, newRange
} from '../testUtil/navigation.js';
