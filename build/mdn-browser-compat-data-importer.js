...
//   atdirectives.forEach(item => {
//     const itemPath = path.resolve(cssAtRulesPath, item.name.slice(1)) + '.json'
//     if (fs.existsSync(itemPath) && !item.browsers && item.status) {
//       console.log(item.name)
//     }
//   })

//   pseudoclasses.forEach(item => {
//     const itemPath = path.resolve(cssSelectorsPath, item.name.slice(1)) + '.json'
//     if (fs.existsSync(itemPath) && !item.browsers && item.status) {
//       console.log(item.name)
//     }
//   })
...
//   pseudoelements.forEach(item => {
//     const itemPath = path.resolve(cssSelectorsPath, item.name.slice(2)) + '.json'
//     if (fs.existsSync(itemPath) && !item.browsers && item.status) {
//       console.log(item.name)
//     }
//   })
...
//   properties.forEach(item => {
//     const itemPath = path.resolve(cssPropertiesPath, item.name) + '.json'
//     if (fs.existsSync(itemPath) && !item.browsers && item.status) {
//       console.log(item.name)
//     }
//   })
